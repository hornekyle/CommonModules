module autoDiffZTrigonometric_mod
	!! @todo
...
contains
	...
	elemental function tan_a(u) result(o)
		...
		o = adZ_t( tan(u%x) , (tan(u%x)**2+1.0_wp)*u%d )
	end function tan_a
	...
	elemental function atan_a(u) result(o)
		...
		o = adZ_t( atan(u%x) , u%d*(1.0_wp+u%x**2)**(-1) )
	end function atan_a

end module autoDiffZTrigonometric_mod 
